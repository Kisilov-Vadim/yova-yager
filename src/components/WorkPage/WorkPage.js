...
import {getToken, getData, setCurrentWorkData} from '../../store/actions'; 

const WorkPage = ({data, works, allImages, currentWorkData, setCurrentWorkData, setIsLoaded}) => {
    ...
    <section className="work">
      <div className="wrapper">
        <div className="work__image">
          <img src={currentWorkData.mainImage || "/img/work/altruist.png"} alt={currentWorkData.title || "Altruist"} />
        </div>
