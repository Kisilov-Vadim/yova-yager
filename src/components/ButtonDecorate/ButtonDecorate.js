...
const ButtonDecorate = ({title}) => {
  return (  
    <div className="decorateButton">
      <button className="decorateButton-button">{title}</button>
      <svg xmlns="http://www.w3.org/2000/svg" width="145" height="82" viewBox="0 0 145 82">
        <g>
          <path fill="none" stroke="#201600" stroke-miterlimit="50" 
